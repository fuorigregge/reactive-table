...
Template.reactiveTable.helpers({
    ...
    'getField': function (object) {
        ...
        var flipColumn = Session.get('isMobileMq');//Template.parentData(2).templateData.settings.flipColumn;
        ...
        if(flipColumn) {
            return new Spacebars.SafeString('<div style="font-weight: bold;width:50%;float:left;" >' + this.label + '</div> ' + field);
        }
        return field;
    },
